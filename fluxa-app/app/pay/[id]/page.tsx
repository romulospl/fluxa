    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4">
      ...
      <Card className="w-full max-w-md border-border bg-card">
        <CardHeader className="text-center">
          ...
          <CardDescription>Cobrança de {mockCharge.createdBy}</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="rounded-lg bg-secondary/50 p-4 text-center">
            ...
            <div className="mt-2 text-sm text-muted-foreground">{mockCharge.description}</div>
          </div>

          <div className="flex gap-2">
            <Button variant={paymentMethod === 'pix' ? 'default' : 'outline'} className="flex-1" onClick={() => setPaymentMethod('pix')}>
              Pix
            </Button>
            <Button variant={paymentMethod === 'boleto' ? 'default' : 'outline'} className="flex-1" onClick={() => setPaymentMethod('boleto')}>
              Boleto
            </Button>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex justify-center">
                <div className="rounded-lg bg-white p-4">
                  ...
                  <img src={mockPixData.qrCodeUrl} alt="QR Code Pix" className="h-48 w-48" />
                </div>
              </div>

              <div className="space-y-2">
                <div className="text-sm font-medium text-card-foreground">Ou copie o código Pix:</div>
                <div className="flex items-center gap-2">
                  ...
                  <Button variant="outline" size="icon" onClick={() => copy(mockPixData.key)}>
              ...
              <div className="rounded-lg border border-border p-4">
                <div className="mb-2 text-sm font-medium text-card-foreground">Como pagar:</div>
